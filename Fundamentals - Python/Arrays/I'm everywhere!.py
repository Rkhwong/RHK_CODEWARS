...
And so John, a programmer at Apple, was given the task of making a program that would add that letter
to every word. Let's help him do it, too.
...
def i(word):
    ...
    if word == '':
        return "Invalid word"
    if word[0].islower() or word[0] == 'i' or word[0] == 'I':
        return "Invalid word"
    for letter in word:
